...
class ElectricKittle(override val applianceType: String) : HouseholdAppliance(""), TemperatureRegulatable, AutomaticShutdown, LightEmitting, WaterStorable,
    Powerable, Openable {
    ...
    override val sensorType: String
        get() = TODO("Not yet implemented")
    override val maSensoredValue: Int
        get() = TODO("Not yet implemented")
